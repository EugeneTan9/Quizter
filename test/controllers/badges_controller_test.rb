...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post badges_url, params: { badge: { criteria: @badge.criteria, img_url: @badge.img_url, quiz_id: @badge.quiz_id, title: @badge.title, user_id: @badge.user_id } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { criteria: @badge.criteria, img_url: @badge.img_url, quiz_id: @badge.quiz_id, title: @badge.title, user_id: @badge.user_id } }
